...
import eventpb "github.com/google/schedviz/tracedata/schedviz_events_go_proto"
...
// all events prior to that time on these CPUs as Clipped.
func ClipFromStartOfTrace(es *eventpb.EventSet, overflowedCPUs map[int64]struct{}) {
...
// all events prior to that time on these CPUs as Clipped.
func ClipFromEndOfTrace(es *eventpb.EventSet, overflowedCPUs map[int64]struct{}) {
	attested := copyMap(overflowedCPUs)
